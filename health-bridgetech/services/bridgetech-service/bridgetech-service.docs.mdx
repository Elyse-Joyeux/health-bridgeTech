---
labels: ['bridgetech-service', 'express', 'server', 'microservice']
description: 'bridgetech service'
---

A bridgetech-service component. Provides a RESTful API for the platform.
...
```bash
bit use bridgetech-service
```

Run the server:
```bash
bit run bridgetech-service
```
