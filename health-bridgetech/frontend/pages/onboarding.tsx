...
const AREA_META: Record<
  string,
  { name: string; desc: string; Icon: typeof HeartIcon }
> = {
  anxiety: {
    name: 'Anxiety',
    desc: 'Calm spiraling thoughts',
    Icon: CloudIcon,
  },
...
export function OnboardingPage() {
  ...
  useEffect(() => {
    api<{ areas: string[]; questions: Record<string, Question[]> }>(
      '/api/onboarding/assessment'
    )
      .then((d: { areas: string[]; questions: Record<string, Question[]> }) =>
    ...
    <div className={styles.shell}>
      ...
      <div className={`${styles.card} ${styles.cardWide}`}>
        <div className={styles.brandHead}>
          <BrandLogo />
          <div className={styles.brandName} style={{ marginTop: 8 }}>
            Health BridgeTech
          </div>
        </div>
          ...
          <div style={{ display: 'flex', gap: 6 }}>
            ...
            <span
              style={{
                ...
                borderRadius: 2,
                background:
                  step === 2 ? 'var(--hb-primary)' : 'var(--hb-border)',
              }}
            />
          </div>
        </div>
        ...
        {step === 1 && (
          <>
            ...
            <p className={styles.subtitle}>
              Pick one or more focus areas. Your Companion, content, and metrics
              will adapt.
            </p>
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: 16,
                      border: active
                        ? '1.5px solid var(--hb-primary)'
                        : '1.5px solid var(--hb-border)',
                      background: active
                        ? 'var(--hb-mint-pale)'
                        : 'var(--hb-surface)',
                      cursor: 'pointer',
        ...
        {step === 2 && (
          <>
            ...
            <p className={styles.subtitle}>
              A few quick questions help your clinician understand the shape of
              what you&rsquo;re navigating.
            </p>
            ...
            <div style={{ display: 'flex', gap: 10, marginTop: 8 }}>
              ...
              <button
                ...
                onClick={submit}
              >
                {loading ? 'Saving...' : 'Enter your sanctuary'}{' '}
